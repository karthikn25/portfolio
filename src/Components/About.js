            ...
            <div className="about-content padd15">
              <div className="row">
                <div className="about-text padd-15">
                  ...
                  <p>
                    I'm a self-taught web developer and Mobile App Developer
                    with experience in designing new features from ideation to
                    production, implementation of wireframes and design flows
                    into high performance software applications. I take into
              ...
              <div className="row">
                <div className="personal-info padd-15">
                  <div className="row">
                    ...
                    <div className="info-item padd-15">
                      <p>
                        Email : <span>mkarthikeyan179@gmail.com</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                        Degree : <span>BE(ECE)</span>
                      </p>
                    </div>
                    <div className="info-item padd-15">
                      <p>
                      ...
                      <div className="timeline">
                        <div className="timeline-item">
                          <div className="circle-dot">
                            ...
                            <p className="timeline-text">
                              I am Completed my Secondary School Leaving
                              Certificate with 91%.
                            </p>
                          </div>
                        </div>
                        <div className="timeline-item">
                          <div className="circle-dot">
                            ...
                            <p className="timeline-text">
                              I am Completed my Higher Secondary Education
                              Certificate with 81%.
                            </p>
                          </div>
                        </div>
                        <div className="timeline-item">
                          <div className="circle-dot">
                            ...
                            <p className="timeline-text">
                              I am Completed my Bachelor of Engineering with
                              75%.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="timeline">
                        <div className="timeline-item">
                          <div className="circle-dot">
                            ...
                            <p className="timeline-text">
                              I'm Checking the In and Out products are same in
                              Invoice and Delivery Challan documents.
                            </p>
                          </div>
                        </div>
                        <div className="timeline-item">
                          <div className="circle-dot">
                            ...
                            <p className="timeline-text">
                              I'm doing Vitrox machine finetuning and In circuit
                              test and Function Component test and checking
                              soldring levels of the products.
                            </p>
                          </div>
                        </div>
                      </div>
