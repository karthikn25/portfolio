...
export default function Skills() {
  return (
    ...
    <div className='bar'><span className='time-management'></span></div>
    <div className='skill-item padd-15'>
    <h5>Leadership</h5>
    <div className='progress'>
    ...
    <div className='bar'><span className='teamwork'></span></div>
    <div className='skill-item padd-15'>
    ...
    <div className='bar'><span className='planning-ability'></span></div>
    <div className='skill-item padd-15'>
    ...
    <div className='bar'><span className='strategic-thinking'></span></div>
    <div className='skill-item padd-15'>
    ...
    <div className='bar'><span className='communication-skill'></span></div>
    <div className='skill-item padd-15'>
    <h5>Dedication</h5>
    <div className='progress'>
    <div className='progress-in' style={{width:"90%"}}>
    ...
    <div className='bar'><span className='dedication'></span></div>
    </div>
    </div>
    <div className='personal-info padd-15'>
    <div className='row'>
    <div className='about-img' style={{marginTop:"100px",marginLeft:"200px"}}>
    ...
    <div className='row'>
    <div className='about-img' style={{marginTop:"100px",marginLeft:"50px"}}>
    <img src={img4} alt='' style={{height:'350px'}}/>
    </div>
    </div>
    </div>
    <div className='skill padd-15'>
    ...
    <div className='bar'><span className='reactjs'></span></div>
    <div className='skill-item padd-15'>
    <h5>SQL</h5>
    <div className='progress'>
    <div className='progress-in' style={{width:"85%"}}>
    ...
    <div className='bar'><span className='nodejs'></span></div>
    </div>
    </div>
    </div>
      </div>
